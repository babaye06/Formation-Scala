jar:file://<HOME>/.cache/coursier/v1/https/repo1.maven.org/maven2/org/scala-lang/scala-library/2.13.10/scala-library-2.13.10-sources.jar!/scala/collection/Iterable.scala
### dotty.tools.dotc.core.TypeError$$anon$1: bad parameter reference CC at typer
the parameter is type CC in trait IterableOps but the prefix <noprefix>
...
action parameters:
offset: 27362
uri: jar:file://<HOME>/.cache/coursier/v1/https/repo1.maven.org/maven2/org/scala-lang/scala-library/2.13.10/scala-library-2.13.10-sources.jar!/scala/collection/Iterable.scala
text:
```scala
/*
...
trait IterableOps[+A, +CC[_], +C] extends Any with IterableOnce[A] with IterableOnceOps[A, CC, C] {
  ...
  def map[B](f: A => B): CC[B] = iterableFactory.fro@@m(new View.Map(this, f))
